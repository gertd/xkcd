...
var defaultBasePath = 'http://xkcd.com';
// ===============================================
...
var DefaultApi = /** @class */ (function () {
     ...
     * @param comicId
     */
    DefaultApi.prototype.xkcdGetComic = function (comicId, options) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/{comicId}/info.0.json'
                        ...
                        return new Promise(function (resolve, reject) {
                            localVarRequest(localVarRequestOptions, function (error, response, body) {
                                if (error) {
                                    ...
                                    body = models_1.ObjectSerializer.deserialize(body, "Comic");
     ...
     */
    DefaultApi.prototype.xkcdGetComicForToday = function (options) {
        if (options === void 0) { options = { headers: {} }; }
        return __awaiter(this, void 0, void 0, function () {
            var localVarPath, localVarQueryParameters, localVarHeaderParams, localVarFormParams, localVarUseFormData, localVarRequestOptions, authenticationPromise;
            var _this = this;
            return __generator(this, function (_a) {
                localVarPath = this.basePath + '/info.0.json';
                localVarQueryParameters = {};
                localVarHeaderParams = Object.assign({}, this.defaultHeaders);
                localVarFormParams = {};
                Object.assign(localVarHeaderParams, options.headers);
